            ...
            <C.PageSpace>
              <A.AI>
                ...
                <A.container>
                  ...
                  <A.content>
                    <A.btn value="text1" selected={selectedType === "text1"} onClick={() => handleTypeClick("text1")}>
                      태양인
                    </A.btn>
                    <A.btn value="text2" selected={selectedType === "text2"} onClick={() => handleTypeClick("text2")}>
                      소양인
                    </A.btn>
                    <A.btn value="text3" selected={selectedType === "text3"} onClick={() => handleTypeClick("text3")}>
                      태음인
                    </A.btn>
                    <A.btn value="text4" selected={selectedType === "text4"} onClick={() => handleTypeClick("text4")}>
                      소음인
                    </A.btn>
                  </A.content>
                </A.container>
