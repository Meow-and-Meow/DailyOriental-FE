...
function Test() {
    ...
    switch (type) {
        ...
        return {
          ...
          info1: (
            <>
              ...
              목덜미가 굵고 실하며 머리가 큰 편이다. 엉덩이가 작고 가슴 윗 부분이 발달했다. <br />
          ...
          info2: (
            <>
              사회적 관계가 원만하고 적극적으로 남들과 소통합니다 <br />
          ...
          info3: (
            <>
              ...
              소변이 잘 나와야 건강합니다
              <br /> 변비가 오래가거나 입에서 침 또는 거품이 지속되면 큰 병일 수 있습니다
              <br />
            </>
          ),
        };
        ...
        return {
          ...
          info3: (
            <>
              폐 기능이 좋고 간의 기능이 약합니다 <br />
              소변이 잘 나와야 건강합니다 <br />
              변비가 오래가거나 입에서 침 또는 거품이 지속되면 큰 병일 수 있습니다 <br />
            </>
          ),
        };
      case 3:
        return {
          ...
          info3: (
            <>
              ...
              소변이 잘 나와야 건강합니다
              <br />
              변비가 오래가거나 입에서 침 또는 거품이 지속되면 큰 병일 수 있습니다
              <br />
            </>
          ),
        };
      case 4:
        return {
          ...
          introText: (
            <>
              소음인은 체형이 균형적으로 발달하였고 <br /> 한국인의 사상체질 중 3위에 속합니다
            </>
          ),

          info1: (
            <>
              상체보다 하체가 균형 있게 발달했으며 키가 작은 편입니다 <br />
              약하고 마른 체형이 많습니다 <br />
          ...
          info2: (
            <>
              ...
              <br />
              세심하고 부드러워 사람들을 잘 조직하는 능력이 있습니다
              <br />
              자주 불안함을 느끼는 편이며 작은 일에도 걱정이 많습니다
              <br />
              내성적이고 여성적인 편이지만 소극적이고 추진력이 약한 편입니다
              <br />
      ...
      default:
        return {
          imageSrc: human1,
          titleSrc: title1,
          introText: "태양인은 전체 사상체질 중 가장 수가 적어 구별하기 어렵다는 특징이 있어요",
          info1: (
            <>
              용모가 뚜렷하고 살이 비후하지 않다. <br />
              목덜미가 굵고 실하며 머리가 큰 편이다. 엉덩이가 작고 가슴 윗 부분이 발달했다. <br />
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API}/accounts/survey/`, bodyText, {
        headers: {
  ...
  const copyToClipboard = () => {
    ...
    navigator.clipboard.writeText(currentUrl).then(
      () => {
        setAlertMessage(["링크 복사를 완료했어요.", <br />, "친구에게 링크를 전달해보세요."]);
  ...
  const saveImage = async () => {
    try {
      ...
      setAlertMessage(["이미지가 저장되었어요.", <br />, "나의 사상체질 결과를 공유해보세요."]);
      setIsAlertOpen(true);
    } catch (error) {
                ...
                <T.Test>
                  ...
                  <T.Detail>
                    <div className="Detailelements">
                      <div className="DetailIntro">{content.introText}</div>
                      <div>
                        <div className="Detailtitle">
                          <span>체형기상</span>
                        </div>
                        <div className="Deatilinfomation1">
                          <span> {content.info1}</span>
                        </div>
                      </div>
                      <div>
                        <div className="Detailtitle">
                      ...
                      <T.ButtonContainer>
                        <T.Button onClick={handleClick}>나의 사상체질로 저장하기</T.Button>
                        <T.Button onClick={toggleModal}>결과 공유하기</T.Button>
                        <T.Button onClick={moveMain}>메인 페이지로 이동</T.Button>
                        <T.Button onClick={moveBack}>다시하기</T.Button>
                      </T.ButtonContainer>
                    </div>
                  </T.Detail>
                </T.Test>
