                ...
                <S.sub_background>
                  ...
                  <S.signup onSubmit={handleSubmit}>
                    <S.content style={{ marginTop: "73px" }}>
                      <S.label>ID</S.label>
                      <S.input type="text" name="id" placeholder="아이디" value={formData.id} onChange={handleChange}></S.input>
                    </S.content>
                    {errorMessage && <S.error_message>{errorMessage}</S.error_message>}
                    <S.content>
                      <S.label>PW</S.label>
                      <S.input type="password" name="password" placeholder="비밀번호" value={formData.password} onChange={handleChange}></S.input>
                    </S.content>
                    <S.content>
                      <S.label>이름</S.label>
                      <S.input type="text" name="name" placeholder="이름" value={formData.name} onChange={handleChange}></S.input>
                    </S.content>
                    <S.content>
                      <S.label>성별</S.label>
                    ...
                    <S.content>
                      ...
                      <S.input type="phone" name="phone" placeholder="010-0000-0000" value={formData.phone} onChange={handleChange}></S.input>
                    </S.content>
                    <S.content>
